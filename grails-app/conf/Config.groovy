...
appName = 'sightings'
security.cas.uriFilterPattern = '/,/urn.*,/upload/edit/.*,/records/user,/mine,/mine.*,/mine/.*,/upload/index/.*,/upload/index.*,/proxy/submitRecord,/proxy/submitLocationBookmark,/proxy/deleteAllLocationBookmarks,/proxy/deleteLocationBookmark,/proxy/deleteLocationBookmark/.*,/recent/admin,/spotter/admin/.*,/records/ajax/admin,/record/delete/.*'
